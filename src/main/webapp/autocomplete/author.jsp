...
try {
	...
	List r = s.createSQLQuery("SELECT firstnames || ' ' || lastname FROM people WHERE (firstnames || ' ' || lastname) LIKE :search ORDER BY lastname, firstnames").setString("search", query).list();
	for ( Object o : r )
		data.add(o.toString());
